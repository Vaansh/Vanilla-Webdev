...
validate.onclick = function() {
	...
	if (validity === false) {
		...
		document.getElementById('notStrong').innerHTML = `Enter a new password. Password not valid! :(`;
	}
	...
	if (validity && strength) {
		...
		document.getElementById('notStrong').innerHTML = `Valid Password! Type in different values to try again:)`;
	}
};
...
function isPasswordValid(un, ps) {
	...
	console.log(`len: ${len} (min should be 8), up: ${up}, low:${low}, spl:${spl}, num:${num}`);
